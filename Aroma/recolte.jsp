                    ...
                    <div class="col-lg-12">
                        <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-4 justify-content-between">
                            <div class="section-title-area">
                                <h1 class="section-title white-color">Recolte</h1>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__checkout-inner">
                            <div class="ltn__checkout-single-content mt-50">
                                <h4 class="title-2">Recolte</h4>
                                <div class="ltn__checkout-single-content-info">
                                    <form action="/Aroma/recolteproduit" method="Get">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-item">
                                                    <select class="nice-select" style="display: block;" name="produitIntermediaire">
                                                        <option>Selectionnez un Produit a</option>
                                        ...
                                        <div class="btn-wrapper">
                                            <input type="submit" placeholder="Quantite ajoutee" value="Utiliser" >
                                        </div>
                                    </form>
                                </div>
                            </div>
