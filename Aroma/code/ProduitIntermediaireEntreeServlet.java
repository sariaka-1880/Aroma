...
public class ProduitIntermediaireEntreeServlet extends HttpServlet{
  ...
  protected void processRequest(HttpServletRequest req, HttpServletResponse res) throws ServletException,IOException,Exception{
    ...
    try{
        ...
        RequestDispatcher dispat = getServletContext().getRequestDispatcher("/produitIntermediaire.jsp");
